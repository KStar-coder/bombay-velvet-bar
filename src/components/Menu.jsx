...
const Menu = () => {
    ...
    }, [currentIndex]) // the animation is dependent on the currentIndex state. It will re-run the animation whenever currentIndex changes.
        ...
        <section id='menu' aria-labelledby='menu-heading'>
            ...
            <div className='content'>
                ...
                <div className="cocktail">
                    <img src={currentCocktail.image} className='object-contain' alt="current-cocktail-img" />
                </div>
